...
function extractTime(text) {
    ...
    words.forEach(word => {
            if (centuryArray.includes(word)) {
                let century = `Appeared in English around the ${word} century`;
                document.getElementById('other-info').innerHTML = century;
                wordHits += 1;
            } else if (decadeArray.includes(word)) {
                let decade = `Appeared in English around the ${word}`;
...
const latAndLongs = {
    ...
    'Polynesia': { 'latitude': -16.578193, 'longitude': 179.414413 },
    ...
    'Uruguay': { 'latitude': -32.5, 'longitude': -55.7 },
    'Paraguay': { 'latitude': -23.4, 'longitude': -58.4 },
    'Vietnam': { 'latitude': 14.4, 'longitude': 108.4 },
...
const randomWordTable = {
    'Andorra': ['We do not have a word from here at the moment'],
    'United Arab Emirates': ['We do not have a word from here at the moment'],
    'Afghanistan': ['afghan'],
    'Antigua and Barbuda': ['We do not have a word from here at the moment'],
    'Anguilla': ['We do not have a word from here at the moment'],
    'Albania': ['We do not have a word from here at the moment'],
    'Armenia': ['lavash'],
    ...
    'Austria': ['wiener'],
    'Australia': ['kangaroo'],
    'Aruba': ['We do not have a word from here at the moment'],
    'Azerbaijan': ['We do not have a word from here at the moment'],
    'Bosnia and Herzegovina': ['We do not have a word from here at the moment'],
    'Barbados': ['We do not have a word from here at the moment'],
    'Bangladesh': ['biryani'],
    'Belgium': ['We do not have a word from here at the moment'],
    'Burkina Faso': ['We do not have a word from here at the moment'],
    'Bulgaria': ['We do not have a word from here at the moment'],
    'Bahrain': ['We do not have a word from here at the moment'],
    'Burundi': ['We do not have a word from here at the moment'],
    'Benin': ['We do not have a word from here at the moment'],
    'Bermuda': ['We do not have a word from here at the moment'],
    'Brunei': ['We do not have a word from here at the moment'],
    'Bolivia': ['We do not have a word from here at the moment'],
    'Brazil': ['samba'],
    'Bahamas': ['We do not have a word from here at the moment'],
    'Bhutan': ['We do not have a word from here at the moment'],
    'Bouvet Island': ['We do not have a word from here at the moment'],
    'Botswana': ['We do not have a word from here at the moment'],
    'Belarus': ['We do not have a word from here at the moment'],
    'Belize': ['We do not have a word from here at the moment'],
    'Canada': ['mohawk'],
    'Cocos [Keeling] Islands': ['We do not have a word from here at the moment'],
    'Congo [DRC]': ['goombay'],
    'Central African Republic': ['We do not have a word from here at the moment'],
    'Congo [Republic]': ['goombay'],
    'Switzerland': ['fondue'],
    'Ivory Coast': ['We do not have a word from here at the moment'],
    'Cook Islands': ['We do not have a word from here at the moment'],
    'Chile': ['cueca'],
    'Cameroon': ['fufu'],
    'China': ['panda'],
    'Colombia': ['merengue'],
    'Costa Rica': ['empanada'],
    'Cuba': ['mambo'],
    'Cape Verde': ['We do not have a word from here at the moment'],
    'Christmas Island': ['We do not have a word from here at the moment'],
    'Cyprus': ['We do not have a word from here at the moment'],
    'Czech Republic': ['goulash'],
    'Germany': ['kindergarten'],
    'Djibouti': ['We do not have a word from here at the moment'],
    'Denmark': ['haggis'],
    'Dominica': ['We do not have a word from here at the moment'],
    'Dominican Republic': ['picante'],
    'Algeria': ['We do not have a word from here at the moment'],
    'Ecuador': ['We do not have a word from here at the moment'],
    'Estonia': ['We do not have a word from here at the moment'],
    'Egypt': ['hummus'],
    'Western Sahara': ['We do not have a word from here at the moment'],
    'Eritrea': ['We do not have a word from here at the moment'],
    'Spain': ['tornado'],
    'Ethiopia': ['injera'],
    'Finland': ['reindeer'],
    'Fiji': ['taro'],
    'Falkland Islands [Islas Malvinas]': ['We do not have a word from here at the moment'],
    'Micronesia': ['taro'],
    'Faroe Islands': ['We do not have a word from here at the moment'],
    'France': ['buffet'],
    'Gabon': ['We do not have a word from here at the moment'],
    'United Kingdom': ['tickle'],
    'Grenada': ['We do not have a word from here at the moment'],
    'Georgia': ['We do not have a word from here at the moment'],
    'French Guiana': ['We do not have a word from here at the moment'],
    'Guernsey': ['We do not have a word from here at the moment'],
    'Ghana': ['fufu'],
    'Gibraltar': ['We do not have a word from here at the moment'],
    'Greenland': ['We do not have a word from here at the moment'],
    'Gambia': ['We do not have a word from here at the moment'],
    'Guinea': ['We do not have a word from here at the moment'],
    'Guadeloupe': ['We do not have a word from here at the moment'],
    'Equatorial Guinea': ['We do not have a word from here at the moment'],
    'Greece': ['moussaka'],
    'South Georgia and the South Sandwich Islands': ['We do not have a word from here at the moment'],
    'Guatemala': ['empanada'],
    'Guam': ['taro'],
    'Guinea-Bissau': ['We do not have a word from here at the moment'],
    'Guyana': ['We do not have a word from here at the moment'],
    'Gaza Strip': ['We do not have a word from here at the moment'],
    'Hong Kong': ['We do not have a word from here at the moment'],
    'Heard Island and McDonald Islands': ['We do not have a word from here at the moment'],
    'Honduras': ['empanada'],
    'Croatia': ['goulash'],
    'Haiti': ['We do not have a word from here at the moment'],
    'Hungary': ['goulash'],
    'Indonesia': ['java'],
    'Ireland': ['We do not have a word from here at the moment'],
    'Israel': ['cherub'],
    'Isle of Man': ['We do not have a word from here at the moment'],
    'India': ['curry'],
    'British Indian Ocean Territory': ['We do not have a word from here at the moment'],
    'Iraq': ['lavash'],
    'Iran': ['kebab'],
    'Iceland': ['haggis'],
    'Italy': ['pizza'],
    'Jersey': ['We do not have a word from here at the moment'],
    'Jamaica': ['We do not have a word from here at the moment'],
    'Jordan': ['We do not have a word from here at the moment'],
    'Japan': ['teriyaki'],
    'Kenya': ['We do not have a word from here at the moment'],
    'Kyrgyzstan': ['We do not have a word from here at the moment'],
    'Cambodia': ['We do not have a word from here at the moment'],
    'Kiribati': ['We do not have a word from here at the moment'],
    'Comoros': ['We do not have a word from here at the moment'],
    'Saint Kitts and Nevis': ['We do not have a word from here at the moment'],
    'North Korea': ['kimchi'],
    'South Korea': ['kimchi'],
    'Kuwait': ['We do not have a word from here at the moment'],
    'Cayman Islands': ['We do not have a word from here at the moment'],
    'Kazakhstan': ['We do not have a word from here at the moment'],
    'Laos': ['We do not have a word from here at the moment'],
    'Lebanon': ['We do not have a word from here at the moment'],
    'Saint Lucia': ['We do not have a word from here at the moment'],
    'Liechtenstein': ['We do not have a word from here at the moment'],
    'Sri Lanka': ['We do not have a word from here at the moment'],
    'Liberia': ['We do not have a word from here at the moment'],
    'Lesotho': ['We do not have a word from here at the moment'],
    'Lithuania': ['We do not have a word from here at the moment'],
    'Luxembourg': ['We do not have a word from here at the moment'],
    'Latvia': ['We do not have a word from here at the moment'],
    'Libya': ['We do not have a word from here at the moment'],
    'Morocco': ['couscous'],
    'Monaco': ['We do not have a word from here at the moment'],
    'Moldova': ['We do not have a word from here at the moment'],
    'Montenegro': ['We do not have a word from here at the moment'],
    'Madagascar': ['We do not have a word from here at the moment'],
    'Marshall Islands': ['We do not have a word from here at the moment'],
    'Macedonia [FYROM]': ['We do not have a word from here at the moment'],
    'Mali': ['We do not have a word from here at the moment'],
    'Myanmar [Burma]': ['We do not have a word from here at the moment'],
    'Mongolia': ['We do not have a word from here at the moment'],
    'Macau': ['We do not have a word from here at the moment'],
    'Northern Mariana Islands': ['We do not have a word from here at the moment'],
    'Martinique': ['We do not have a word from here at the moment'],
    'Mauritania': ['We do not have a word from here at the moment'],
    'Montserrat': ['We do not have a word from here at the moment'],
    'Malta': ['We do not have a word from here at the moment'],
    'Mauritius': ['We do not have a word from here at the moment'],
    'Maldives': ['We do not have a word from here at the moment'],
    'Malawi': ['We do not have a word from here at the moment'],
    'Mexico': ['burrito'],
    'Malaysia': ['gong'],
    'Mozambique': ['We do not have a word from here at the moment'],
    'Namibia': ['We do not have a word from here at the moment'],
    'New Caledonia': ['We do not have a word from here at the moment'],
    'Niger': ['impala'],
    'Norfolk Island': ['We do not have a word from here at the moment'],
    'Nigeria': ['zebra'],
    'Nicaragua': ['We do not have a word from here at the moment'],
    'Netherlands': ['woman'],
    'Norway': ['Thursday'],
    'Nepal': ['sherpa'],
    'Nauru': ['We do not have a word from here at the moment'],
    'Niue': ['We do not have a word from here at the moment'],
    'New Zealand': ['kiwi'],
    'Oman': ['salaam'],
    'Panama': ['We do not have a word from here at the moment'],
    'Peru': ['We do not have a word from here at the moment'],
    'French Polynesia': ['taro'],
    'Papua New Guinea': ['We do not have a word from here at the moment'],
    'Philippines': ['tagalog'],
    'Pakistan': ['sari'],
    'Poland': ['pierogi'],
    'Saint Pierre and Miquelon': ['We do not have a word from here at the moment'],
    'Pitcairn Islands': ['We do not have a word from here at the moment'],
    'Puerto Rico': ['tostones'],
    'Palestinian Territories': ['We do not have a word from here at the moment'],
    'Portugal': ['albatross'],
    'Palau': ['We do not have a word from here at the moment'],
    'Paraguay': ['We do not have a word from here at the moment'],
    'Qatar': ['We do not have a word from here at the moment'],
    'Réunion': ['We do not have a word from here at the moment'],
    'Romania': ['We do not have a word from here at the moment'],
    'Serbia': ['We do not have a word from here at the moment'],
    'Russia': ['balaclava'],
    'Rwanda': ['We do not have a word from here at the moment'],
    'Saudi Arabia': ['coffee'],
    'Solomon Islands': ['We do not have a word from here at the moment'],
    'Seychelles': ['We do not have a word from here at the moment'],
    'Sudan': ['We do not have a word from here at the moment'],
    'Sweden': ['haggis'],
    'Singapore': ['We do not have a word from here at the moment'],
    'Saint Helena': ['We do not have a word from here at the moment'],
    'Slovenia': ['We do not have a word from here at the moment'],
    'Svalbard and Jan Mayen': ['We do not have a word from here at the moment'],
    'Slovakia': ['goulash'],
    'Sierra Leone': ['We do not have a word from here at the moment'],
    'San Marino': ['We do not have a word from here at the moment'],
    'Senegal': ['We do not have a word from here at the moment'],
    'Somalia': ['We do not have a word from here at the moment'],
    'Suriname': ['We do not have a word from here at the moment'],
    'São Tomé and Príncipe': ['We do not have a word from here at the moment'],
    'El Salvador': ['We do not have a word from here at the moment'],
    'Syria': ['lavash'],
    'Swaziland': ['We do not have a word from here at the moment'],
    'Turks and Caicos Islands': ['We do not have a word from here at the moment'],
    'Chad': ['We do not have a word from here at the moment'],
    'French Southern Territories': ['We do not have a word from here at the moment'],
    'Togo': ['We do not have a word from here at the moment'],
    'Thailand': ['We do not have a word from here at the moment'],
    'Tajikistan': ['We do not have a word from here at the moment'],
    'Tokelau': ['We do not have a word from here at the moment'],
    'Timor-Leste': ['We do not have a word from here at the moment'],
    'Turkmenistan': ['We do not have a word from here at the moment'],
    'Tunisia': ['We do not have a word from here at the moment'],
    'Tonga': ['We do not have a word from here at the moment'],
    'Turkey': ['kiosk'],
    'Trinidad and Tobago': ['We do not have a word from here at the moment'],
    'Tuvalu': ['We do not have a word from here at the moment'],
    'Taiwan': ['We do not have a word from here at the moment'],
    'Tanzania': ['We do not have a word from here at the moment'],
    'Ukraine': ['We do not have a word from here at the moment'],
    'Uganda': ['We do not have a word from here at the moment'],
    'U.S. Minor Outlying Islands': ['We do not have a word from here at the moment'],
    'United States': ['opossum'],
    'Uruguay': ['We do not have a word from here at the moment'],
    'Uzbekistan': ['We do not have a word from here at the moment'],
    'Vatican City': ['We do not have a word from here at the moment'],
    'Saint Vincent and the Grenadines': ['We do not have a word from here at the moment'],
    'Venezuela': ['Barbecue'],
    'British Virgin Islands': ['We do not have a word from here at the moment'],
    'U.S. Virgin Islands': ['We do not have a word from here at the moment'],
    'Vietnam': ['pho'],
    'Vanuatu': [''],
    'Wallis and Futuna': ['We do not have a word from here at the moment'],
    'Samoa': ['We do not have a word from here at the moment'],
    'Kosovo': ['We do not have a word from here at the moment'],
    'Yemen': ['salaam'],
    'Mayotte': ['We do not have a word from here at the moment'],
    'South Africa': ['zulu'],
    'Zambia': ['We do not have a word from here at the moment'],
    'Zimbabwe': ['We do not have a word from here at the moment'],
}